...
API_ID = int(getenv("25504018", ""))
API_HASH = getenv("23921d8a2af517d76fc80bd502185e37", "")

# Get your token from @BotFather on Telegram.
BOT_TOKEN = getenv("6600301561:AAG19psIagxoHeLiVXDvc33X7jhIAEJuakc", None)
...
LOGGER_ID = int(getenv("LOGGER_ID", -1002188901873)
